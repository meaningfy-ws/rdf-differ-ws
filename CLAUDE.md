...
This project is indexed by GitNexus as **rdf-differ-ws** (5362 symbols, 7153 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
