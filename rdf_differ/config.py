...
RDF_DIFFER_REDIS_LOCATION = os.environ.get('RDF_DIFFER_REDIS_LOCATION', 'localhost')
RDF_DIFFER_REDIS_PORT = os.environ.get('RDF_DIFFER_REDIS_PORT', 6379)
RDF_DIFFER_REDIS_SERVICE = f'redis://{RDF_DIFFER_REDIS_LOCATION}:{RDF_DIFFER_REDIS_PORT}'
