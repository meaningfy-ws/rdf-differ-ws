...
from rdf_differ.api.services.queue import (
...
@patch("rdf_differ.api.services.queue.push_task_to_queue")
@patch("rdf_differ.api.services.queue.task_exists_in_queue")
...
@patch("rdf_differ.api.services.queue.cleanup_diff_creation")
@patch("rdf_differ.api.services.queue.revoke_task")
...
@patch("rdf_differ.api.services.queue.cleanup_report_creation")
@patch("rdf_differ.api.services.queue.revoke_task")
...
@patch("rdf_differ.api.services.queue.remove_report")
...
@patch("rdf_differ.api.services.queue.FusekiDiffAdapter")
