...
from rdf_differ.reporting.services.report_handling import build_report
...
@patch("rdf_differ.reporting.services.report_handling.ReportBuilder")
@patch("rdf_differ.reporting.services.report_handling.shutil.copytree")
