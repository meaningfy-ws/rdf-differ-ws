...
@patch("rdf_differ.entrypoints.api.handlers.ApplicationProfileManager")
...
@patch("rdf_differ.entrypoints.api.handlers.retrieve_active_tasks")
...
@patch("rdf_differ.entrypoints.api.handlers.retrieve_task")
...
@patch("rdf_differ.entrypoints.api.handlers.kill_task")
@patch("rdf_differ.entrypoints.api.handlers.flatten_active_tasks")
@patch("rdf_differ.entrypoints.api.handlers.retrieve_active_tasks")
